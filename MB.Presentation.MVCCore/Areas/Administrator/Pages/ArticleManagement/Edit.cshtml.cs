...
namespace MB.Presentation.MVCCore.Areas.Administrator.Pages.ArticleManagement
{
    public class EditModel : PageModel
    {
        ...
        public List<SelectListItem> ArticleCategpries { get; set; }
        ...
        public void OnGet(long id)
        {
            ...
            ArticleCategpries = _articleCategoryApplication.List().Select(x => new SelectListItem(x.Title, x.Id.ToString())).ToList();
        }
